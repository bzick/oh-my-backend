...
> Цитатой обозначется пояснение к пункту для чего следует это знать и/или где с этим можно столкнуться.
...
<kbd>sinior</kbd> смотрит на это с грустью в глазах, так как это уже про софт-скиллы. А <kbd>high middle</kbd> как раз путают с <kbd>sinior</kbd>. 
У всех свои разделения на градации, тут они используются что бы помочь поделить кучу знаний на то что стоит изучать в первую очередь.
