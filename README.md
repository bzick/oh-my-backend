...
1. Методологии разработки
   ...
   * [TDD](https://habr.com/ru/company/ruvds/blog/450316/) (Test Driven Development)
     > Разработка через тестирование, самы изестный способо разработки, требующий от разработчика сначала паписание тестка к коду, а потом сам код.
...
1. Распределенные системы
   ...
   > Это сильно усложняет приложение и много ресурсов ухождит на сохранение целостности и согласованности данных.
