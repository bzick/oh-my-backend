...
* **[Этап 7. Тут должен быть ваш язык программирования](#этап-8-тут-должен-быть-ваш-язык-программирования)**
* [Этап 8. Безопасность](#этап-7-безопасность)
...
* [Этап 13. Брокеры сообщений](#этап-13-брокеры-сообщений)
...
# Этап 7. Тут должен быть ваш язык программирования
...
# Этап 13. Брокеры сообщений

В больших распределённых системах доставка сообщений сервис-сервис, клиент-сервис, сервис-клиент делается через брокеры сообщений (не уместно их называть очередями сообщений, но так их часто называют).
