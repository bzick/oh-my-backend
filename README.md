...
Ссылка на вики ставится что бы исключить ошибочного варианта статьи на вики. 
...
* [Этап 7. Web сервер NGINX](#этап-7-web-сервер-nginx)
...
Даже если уже имеет Linux на рабочей машине, всэ равно поднимите виртуализацию. В случае чего, виртуальную машину всегда можно пересоздать.
