...
1. установить [docker](https://www.docker.com/products/docker-desktop) [junior]
1. запустить контейнер с Linux Ubuntu, последней [LTS версией](https://ru.wikipedia.org/wiki/Список_версий_Ubuntu#История_выпусков). Запустить bash (консоль) контейнера. [junior]
...
1. docker compose для поднятия кластера контейнеров. [middle]
