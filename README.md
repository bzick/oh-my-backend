...
**Что это?** Этот документ содержит список базовых навыков, которые **часто** требуются backend разработчику web-приложений. 

Каждый пункт, в документе, подразумевает что:
