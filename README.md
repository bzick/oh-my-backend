...
- junior <kbd>junior</kbd> ★☆☆
- middle <kbd>middle</kbd> ★★☆
- high middle <kbd>middle+</kbd> ★★★
...
- <sub><sup>🔴</sup></sub> high middle (путают с senior), понимать как работают пункты junior и middle, разбираться в своих пунктах.
...
А где sinior? Sinior смотрит на это с грустью в глазах, так как это уже про софт-скиллы.
