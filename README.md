...
1. [Типы приложения](https://dou.ua/forums/topic/31720/)
   > Существует разделение приложения по способу построения UI.
   * MPA (Multi-Page Application)
     > Классический тип приложения с несколькими генерируемыми на бэкенде страницами вместе UI.
   ...
   * SSR (Server Side Rendering)
     > Подход к генерации страниц приложения. Каждый запрос обрабатывается на сервере, где и строится UI.
   * CSR (Client Side Rendering)
     > Подход к генерации страниц приложения. Весь UI строится в браузере при помощи JS. JS делает запросы на сервера за данными, для построения или изменения UI. 
