...
1. Ваш язык программирования <kbd>junior</kbd>
   ...
   * Объекты/классы/структуры, прототипы/интерфейсы/миксины.
     ...
     * Перегрузка операторов
       > Позволяет определить несколько методов с одинаковым названием, но разной сигнатурой.
     * Перегрузка методов
...
2. Распараллеливание <kbd>middle</kbd>
   * Процессы
...
3. Пакетный менеджер или менеджер зависимостей. <kbd>junior</kbd>
4. Расширения языка
...
9. Юнит тестирование <kbd>junior</kbd>
   > Ознакомление с системой тестирования в вашем языке. Подбор пакета/модуля для тестирования.
10. Специфика работы IO (сокетов, дескрипторов, потоков) <kbd>middle</kbd>
   * Буферы IO
   * Асинхронный IO
