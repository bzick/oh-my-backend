...
1. Ваш язык программирования <kbd>junior</kbd>
   ...
   * Объекты/классы/структуры, прототипы/интерфейсы/миксины.
     ...
     * Перегрузка операторов
       > Позволяет объектам самим определять как над ними производить математические, логические и прочие действия.
     * Перегрузка методов
       > Позволяет определить несколько методов с одним названием, но с разной сигнатурой.
       > Как правило это разный набор параметров (количеством или типами принимаемых значений) для каждого метода.
     * Generics (aka генерики aka шаблоны aka обобщения)
       ...
       > Позволяет определить некоторую одну функциональность (один метод или несколько методов) для разных типов.
